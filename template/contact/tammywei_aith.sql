...
--
-- Host: 127.0.0.1
-- Generation Time: May 16, 2019 at 11:16 PM
...
INSERT INTO `contact` (`name`, `email`, `questionscomments`, `position`) VALUES
...
--
ALTER TABLE `contact`
  MODIFY `name` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
